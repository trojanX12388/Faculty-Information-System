...
#                                                    LEAVE OF ABSENCE MANAGEMENT ROUTE
        
# ------------------------------- LEAVE OF ABSENCE MANAGEMENT ----------------------------  

@LAM.route("/Leave-Absence-Management", methods=['GET', 'POST'])
@login_required
@Check_Token
def LAM_H():
    # INITIALIZING DATA FROM USER LOGGED IN ACCOUNT    
        ...
        return render_template("Faculty-Home-Page/Leave-Absence-Management/index.html", 
